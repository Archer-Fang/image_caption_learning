...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_json', default='data2/cocotalk_attr.json', help='output json file')
    parser.add_argument('--output_h5', default='data2/cocotalk_attr', help='output h5 file')
