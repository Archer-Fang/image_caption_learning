...
def parse_opt():
    ...
    # Data directories
    parser.add_argument('--input_json', type=str, default='data2/cocotalk_attr.json',
    ...
    parser.add_argument('--input_label_h5', type=str, default='data2/cocotalk_attr_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
        
    parser.add_argument('--input_attr_label_dir', type=str, default='data2/coco_attr_label',
                    help='path to the directory containing the labels of atttributes')    
    parser.add_argument('--input_subsequent_label_dir', type=str,default='data2/coco_subsequent_label',
